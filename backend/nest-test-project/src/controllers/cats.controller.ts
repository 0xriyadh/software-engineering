...
export class CatsController {
  @Get() // @Get is a method decorator that binds the route /cats to the findAll() method. The method name is arbitrary and does not impact the behavior of the application. We can name it anything we want. But we must declare a method to bind it to a route.
  findAll(): string {
